...
class CropperPage extends Component {
    constructor(props) {
        ...
        const bottomOuterPosition = new Animated.ValueXY({
            x: LEFT_VALUE - BORDER_WIDTH,
            y: SCREEN_HEIGHT - BOTTOM_VALUE
        });
        ...
        const bottomLeftPosition = new Animated.ValueXY({
            x: LEFT_VALUE - BORDER_WIDTH,
            y: SCREEN_HEIGHT - BOTTOM_VALUE
        });
